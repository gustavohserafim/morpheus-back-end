...
function table(response) {
    ...
    //--->create data table > start
                ...
                $(document).on('click', '.btn_save', function(event)
                {
                    ...
                    $.when(updateMeasurement(arr)).done(function () {
                        getMeasurement();
                    });
...
function getStylesheet() {
      ...
      if (0 <= currentTime&&currentTime < 5) {
          $('#nightmode').html("<link rel='stylesheet' href='night.css' type='text/css'>");
      }
      if (5 <= currentTime&&currentTime < 11) {
          $('#nightmode').html("<link rel='stylesheet' href='day.css' type='text/css'>");
      }
